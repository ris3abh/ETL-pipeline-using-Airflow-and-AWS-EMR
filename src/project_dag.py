...
local_script = "/home/rishabhsharma/airflow-local/dags/Olist_scripts/spark_missed_deadline_job.py"
...
client = boto3.client('emr',region_name = 'us-east-1',aws_access_key_id='xxxxxxxxx', aws_secret_access_key='xxxxxxxxxx')
